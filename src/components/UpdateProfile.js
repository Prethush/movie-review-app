...
function UpdateProfile(props) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if(username && passwd && email && bio) {
      if(!error.username && !error.email && !error.passwd) {
        fetch(getUser + "/" + props.match.params.username, {
          method: "PUT", 
          body: JSON.stringify({user: {username, passwd, email, bio}}),
          headers: {
              ...
              <div className="mx-auto flex lg:justify-center h-full flex-col lg:flex-row">
                  <div className="w-full lg:w-1/2 px-2 py-20 sm:py-40 sm:px-12 flex flex-col justify-center items-center bg-indigo-600 relative">
                      ...
                      <div className="flex relative z-30 flex-col justify-center px-4 md:pr-12">
                          ...
                          <h3 className="text-4xl pt-8 leading-tight text-white text-center">The Cinemaholic</h3>
                      </div>
                  ...
                  <form onSubmit={handleSubmit} className="w-full lg:w-1/2 flex justify-center bg-white dark:bg-gray-900">
                      <div className="w-full sm:w-4/6 md:w-3/6 lg:w-2/3 text-gray-800 dark:text-gray-100 flex flex-col justify-center px-2 sm:px-0 py-16">
                          <div className="px-2 sm:px-6">
                              <h3 className="text-2xl sm:text-3xl md:text-2xl font-bold leading-tight">Update Profile Data</h3>
                          </div>
                          <div className="mt-8 w-full px-2 sm:px-6">
                            <span className="text-red-500">{info}</span>
                              <div className="flex flex-col mt-5">
                                  <label htmlFor="username" className="text-lg font-semibold fleading-tight">
                                      Username
                                  </label>
                                  <input id="username" value={username} name="username" type="text" onChange={handleChange} className="h-10 px-2 w-full rounded mt-2 text-gray-600 focus:outline-none focus:border focus:border-indigo-700 dark:focus:border-indigo-700 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 border-gray-300 border shadow" />
                              ...
                              <div className="flex flex-col mt-8">
                                  ...
                                  <input id="email" name="email" onChange={handleChange} value={email} className="h-10 px-2 w-full rounded mt-2 text-gray-600 focus:outline-none focus:border focus:border-indigo-700 dark:focus:border-indigo-700 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 border-gray-300 border shadow" type="email" />
                              ...
                              <div className="flex flex-col mt-5">
                                  ...
                                  <input id="password" onChange={handleChange} value={passwd} name="passwd" type="password" className="h-10 px-2 w-full rounded mt-2 text-gray-600 focus:outline-none focus:border focus:border-indigo-700 dark:focus:border-indigo-700 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 border-gray-300 border shadow" />
                                  <span className="text-red-500">{error.passwd}</span>
                              </div>
                              <div className="flex flex-col mt-5">
                                  <label htmlFor="bio" className="text-lg font-semibold fleading-tight">
                                      Bio
                                  </label>
                                  <textarea id="bio" onChange={(e) => setBio(e.target.value)} value={bio} name="bio" type="text" rows="6" className="px-2 w-full rounded mt-2 text-gray-600 focus:outline-none focus:border focus:border-indigo-700 dark:focus:border-indigo-700 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 border-gray-300 border shadow"></textarea>
                              </div>
                          </div>
                          <div className="px-2 sm:px-6">
