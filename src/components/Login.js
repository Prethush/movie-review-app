...
function Login(props){
  ...
  const handleSubmit = (e) => {
    ...
    if(email && passwd) {
      fetch(loginURL, {
        method: "POST",
        body: JSON.stringify({user: {email, passwd}}),
        headers: {
      ...
      setInfo("Email/Password required");
    }
  }
                      ...
                      <div className="w-full sm:w-4/6 md:w-3/6 lg:w-2/3 text-gray-800 dark:text-gray-100 flex flex-col justify-center px-2 sm:px-0 py-16">
                          ...
                          <div className="mt-8 w-full px-2 sm:px-6">
                              ...
                              <div className="flex flex-col mt-8">
                                  ...
                                  <input id="email" name="email" onChange={(e) => setEmail(e.target.value)} value={email} className="h-10 px-2 w-full rounded mt-2 text-gray-600 focus:outline-none focus:border focus:border-indigo-700 dark:focus:border-indigo-700 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 border-gray-300 border shadow" type="email" />
                              ...
                              <div className="flex flex-col mt-5">
                                  ...
                                  <input id="password" onChange={(e) => setPasswd(e.target.value)} value={passwd} name="passwd" type="password" className="h-10 px-2 w-full rounded mt-2 text-gray-600 focus:outline-none focus:border focus:border-indigo-700 dark:focus:border-indigo-700 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 border-gray-300 border shadow" />
